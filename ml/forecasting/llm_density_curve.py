...
SCRATCH = Path(
    "/tmp/claude-0/-home-user-AI-Pro-project/13a719e5-acff-5289-a79f-baead6ecad81/scratchpad"
)
...
def main(argv=None) -> int:
    ...
    print(
        f"  {'N_events':>9s} {'active_bh':>9s} {'WAPE_A0':>8s} {'WAPE_A1':>8s}  {'permit A1-A0':>18s}"
    )
    for c in res["curve"]:
        print(
            f"  {c['n_events_sampled']:>9d} {c['test_active_borough_hours']:>9d} {c['wape_A0']:>8.4f} "
