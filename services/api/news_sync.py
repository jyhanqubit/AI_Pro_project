    ...
    *,
    ...
    try:
        ...
        return {
            ...
            "note": (
                "지금은 실시간 뉴스를 불러올 수 없습니다(네트워크/API 연결 없음). 아웃바운드 "
                "네트워크가 있는 환경에서는 무료·키 불필요 GDELT DOC 2.0에서 그대로 동작합니다."
            ),
        }
    ...
    return {
        ...
        "note": (
            "GDELT DOC 2.0(무료·키 불필요)에서 실시간으로 가져온 뉴스입니다. 제목·메타데이터만 "
            "제공되어 본문(text)은 비어 있습니다. 수집분은 뉴스 벡터 스토어에 누적되어 뉴스 "
            "검색에서 바로 찾을 수 있습니다."
        ),
    }
