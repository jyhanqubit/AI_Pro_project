...
def test_leakage_gate_no_feature_before_available_at():
    ...
    assert (
        idx[("Manhattan", "2026-05-10 20")]["news_llm_active"] > 0
    )  # first available hour present
    ...
    ev = [
        {
            ...
            "event_start_at": "2026-05-16T04:00:00-04:00",
            "event_end_at": "2026-05-16T23:00:00-04:00",
        }
    ]
    ...
    ev = [
        {
            ...
            "severity": 0.4,
            "boroughs": ["Brooklyn"],
            "event_start_at": "2026-05-07T20:00:00-04:00",
...
def test_signed_demand_signal_carries_the_llm_direction():
    ...
    storm = {
        ...
        "demand_effect": -0.9,
        "boroughs": ["Manhattan"],
        "event_start_at": "2026-01-24T08:00:00-05:00",
    ...
    fest = {
        ...
        "demand_effect": 0.5,
        "boroughs": ["Brooklyn"],
        "event_start_at": "2026-05-15T12:00:00-04:00",
