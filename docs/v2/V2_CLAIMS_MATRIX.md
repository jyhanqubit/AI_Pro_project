...
| Copilot correctness + relevance | V2-06 | `reports/v2/copilot/{correctness,graphrag}_benchmark.json` | **offline_benchmark** | **Typed-tool**: 20 Q, real claude routing 1.0/1.0/1.0, hallucinated=0 (keyword stand-in 3, FAIL). **GraphRAG @ scale**: real graph 2,895 events/6 zones/2,808 edges, 21 Q — grounding+relevance 21/21 F1 1.0 refuse 6/6; grounding-only 1/21; no-retrieval hallucinates 21/21. Relevance matters MORE at scale |
