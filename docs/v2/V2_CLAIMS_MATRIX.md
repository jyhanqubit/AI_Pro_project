...
| Copilot correctness + relevance | V2-06 | `reports/v2/copilot/{correctness,graphrag}_benchmark.json` | **offline_benchmark** | **Typed-tool half**: 20 Q, real claude routing 1.0/1.0/1.0, hallucinated=0 (keyword stand-in 3, FAIL). **GraphRAG half**: event-graph retrieval, grounding+relevance correct 10/10, refuse 4/4, F1 1.0 (no-retrieval hallucinates 10/10). Both parts of evidence #6 covered |
