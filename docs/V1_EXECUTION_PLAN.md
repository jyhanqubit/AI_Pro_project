...
| **V1-04** Event-lift evaluation | Does news/graph reduce holdout error? | `reports/v1/event_lift/*` | Paired comparison + CI on real news+labels; honest non-improvement | V1-03 |
